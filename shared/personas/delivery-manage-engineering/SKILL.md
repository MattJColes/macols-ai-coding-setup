...
### Acceptance Criteria (from delivery-plan-products)
...
Acceptance criteria come from delivery-plan-products; you make them buildable and
testable and confirm quality-plan-testing has coverage planned.
...
- **RACI** for anything with more than two parties, so ownership is explicit:
  ...
  | Activity | R | A | C | I |
  |----------|---|---|---|---|
  | [thing]  | @dev | @em | delivery-plan-products | stakeholders |
...
- **Decision log** — capture the call, the why, and the date so it isn't
  ...
  **Consequences:** [trade-offs accepted]
  ...
  (delivery-coordinate-projects persists these in the Memory Bank's systemPatterns.md.)
