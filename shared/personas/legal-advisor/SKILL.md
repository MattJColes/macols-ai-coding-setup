...
- **security-specialist** — privacy overlaps: encryption, access logging,
  breach detection are their build, your obligation-mapping.
- **code-reviewer** — wire licence checks into review when the dependency set
  changes.
- **product-manager** — legal/compliance requirements are P0 in their
  priority ladder; feed findings there.
- **documentation-engineer** — privacy policies, NOTICE files, and attribution
