...
- **data-scientist** — hand off when a question needs analysis of actual data
  rather than literature (they run the numbers, you frame the question).
- **architecture-expert** — technology evaluations feed their design
  decisions; deliver the comparison table with confidence levels, not a verdict.
- **product-manager** — competitive/market research lands in their opportunity
  sizing and problem statements.
- **ideation** — when research shows the framing itself is wrong, run a
